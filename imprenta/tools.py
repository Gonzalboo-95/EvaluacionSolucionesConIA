...
@tool(
    ...
    return_direct=True,
    description=(
        "Recupera información técnica relevante de manuales y fuentes indexadas en FAISS para la Canon iX6810. "
        "Devuelve fuentes y fragmentos útiles para diagnósticos técnicos."
    ),
)
...
@tool(
    ...
    return_direct=True,
    description=(
        "Busca información general en Wikipedia para términos técnicos o componentes relacionados con impresión y mantenimiento. "
        "Devuelve un resumen breve y útil."
    ),
)
...
@tool(
    ...
    return_direct=True,
    description=(
        "Analiza síntomas de impresión y devuelve posibles causas e hipótesis de acción para la Canon iX6810."
    ),
)
...
@tool(
    ...
    return_direct=True,
    description=(
        "Genera una orden de trabajo técnica para reparar la impresora, incluyendo prioridad y una breve lista de pasos recomendados."
    ),
)
...
@tool(
    ...
    return_direct=True,
    description=(
        "Recomienda equipo, materiales y configuración de impresión adecuados para trabajos de imprenta concretos."
    ),
)
